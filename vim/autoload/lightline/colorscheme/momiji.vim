...
if exists('g:lightline')
  ...
  let s:p.normal.left     = [ [ s:bright_white, s:grayscale4 ], [ s:bright_white, s:grayscale2 ] ]
  let s:p.normal.right    = [ [ s:bright_white, s:grayscale4 ], [ s:bright_white, s:grayscale2 ] ]
  ...
  let s:p.visual.left     = [ [ s:black, s:cyan ], [ s:bright_white, s:grayscale4 ] ]
  let s:p.visual.right    = [ [ s:black, s:cyan ], [ s:bright_white, s:grayscale4 ] ]
